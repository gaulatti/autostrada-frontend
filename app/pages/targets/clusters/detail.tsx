...
/**
 * The `ClusterDetail` component is responsible for rendering the detailed view of a specific URL report.
 ...
 * @example
 * ```tsx
 * <Route path="/urls/:slug" element={<ClusterDetail />} />
 * ```
 *
 * @dependencies
...
const ClusterDetail = () => {
   ...
   * Phased opening
   */
  if (!featureFlags('iWebdBcrPAEyiYEqbRECx').isEnabled()) {
    return <Forbidden />;
  }
